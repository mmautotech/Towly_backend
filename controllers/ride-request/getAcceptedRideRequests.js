 ...
 *     responses:
 *       200:
 *         description: Accepted ride requests returned
 */
const getAcceptedRide_postedRequests = async (req, res, next) => {
  try {
    ...
    return sendSuccessResponse(res, "Accepted ride requests", formatted);
  } catch (error) {
    next(error);
  }
};

module.exports = getAcceptedRide_postedRequests;
